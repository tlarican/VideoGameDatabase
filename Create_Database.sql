...
insert into KILL_COUNTER
values ('GoodEmail@domain.com', 'GoodGuyJohn', '01', 30, 0),
       ('GoodEmail@domain.com', 'GoodGuyJohn', '02', 25, 1),
       ('GoodEmail@domain.com', 'GoodGuyJohn', '03', 4, 0),
       ('GoodEmail@domain.com', 'GoodGuyJohn', '04', 2, 3),
       ('GoodEmail@domain.com', 'GoodGuyJohn', '06', 8, 0),
       ('GoodEmail@domain.com', 'GoodGuyJohn', '09', 17, 0),
       ('GenericEmail@live.com', 'YourCarry', '01', 301, 1),
       ('GenericEmail@live.com', 'YourCarry', '02', 252, 1),
       ('GenericEmail@live.com', 'YourCarry', '03', 106, 0),
       ('GenericEmail@live.com', 'YourCarry', '04', 78, 0),
       ('GenericEmail@live.com', 'YourCarry', '05', 59, 0),
       ('GenericEmail@live.com', 'YourCarry', '06', 143, 0),
       ('GenericEmail@live.com', 'YourCarry', '07', 112, 0),
       ('GenericEmail@live.com', 'YourCarry', '08', 8, 1),
       ('GenericEmail@live.com', 'YourCarry', '09', 88, 0),
       ('GenericEmail@live.com', 'YourCarry', '10', 12, 1),
       ('SomePerson@yahoo.com', 'WizardyGuy', '01', 98, 1),
       ('SomePerson@yahoo.com', 'WizardyGuy', '02', 46, 1),
       ('SomePerson@yahoo.com', 'WizardyGuy', '03', 24, 1),
       ('SomePerson@yahoo.com', 'WizardyGuy', '04', 6, 2),
       ('SomePerson@yahoo.com', 'WizardyGuy', '05', 9, 1),
       ('SomePerson@yahoo.com', 'WizardyGuy', '06', 28, 0),
       ('SomePerson@yahoo.com', 'WizardyGuy', '07', 49, 1),
       ('Noob123@gmail.com', 'NoobGuy', '01', 23, 4),
       ('Noob123@gmail.com', 'NoobGuy', '02', 14, 3),
       ('Noob123@gmail.com', 'NoobGuy', '03', 0, 4),
       ('AveragePlayer@hotmail.com', 'AverageMage', '01', 113, 1),
       ('AveragePlayer@hotmail.com', 'AverageMage', '02', 102, 0),
       ('AveragePlayer@hotmail.com', 'AverageMage', '03', 33, 2),
       ('AveragePlayer@hotmail.com', 'AverageMage', '04', 10, 2),
       ('AveragePlayer@hotmail.com', 'AverageMage', '05', 3, 1),
       ('AveragePlayer@hotmail.com', 'AverageMage', '06', 67, 0);
       
insert into QUEST_COUNTER
values ('GoodEmail@domain.com', 'GoodGuyJohn', 1, TRUE),
       ('GoodEmail@domain.com', 'GoodGuyJohn', 2, TRUE),
       ('GoodEmail@domain.com', 'GoodGuyJohn', 3, FALSE),
       ('SomePerson@yahoo.com', 'FirstCharacterEver', 1, TRUE),
       ('SomePerson@yahoo.com', 'FirstCharacterEver', 2, TRUE),
       ('SomePerson@yahoo.com', 'FirstCharacterEver', 3, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 1, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 2, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 3, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 4, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 5, TRUE),
       ('GenericEmail@live.com', 'YourCarry', 6, TRUE),
       ('Noob123@gmail.com', 'NoobGuy', 1, FALSE),
       ('AveragePlayer@hotmail.com', 'AverageMage', 1, TRUE),
       ('AveragePlayer@hotmail.com', 'AverageMage', 2, TRUE),
       ('AveragePlayer@hotmail.com', 'AverageMage', 3, TRUE),
       ('AveragePlayer@hotmail.com', 'AverageThief', 1, TRUE),
       ('AveragePlayer@hotmail.com', 'AverageThief', 2, TRUE);
